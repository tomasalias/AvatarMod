...
public class EntityOstrichHorse extends AnimalEntity {
	public EntityOstrichHorse(EntityType<? extends EntityOstrichHorse> entityType, World world) {
	...
	protected void initGoals() {
		...
		goalSelector.add(2, new TemptGoal(this, 1.0, Ingredient.ofItems(Items.WHEAT), false));
